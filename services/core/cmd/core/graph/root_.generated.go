...
# 
type Category @goModel(model: "github.com/smithg09/core/internal/module/category.Category") {
  id: Uuid!
  name: String!
  slug: String
...
enum CategoryStatusEnum @goModel(model: "github.com/smithg09/core/internal/module/category.CategoryStatus") {
  ACTIVE
  PENDING
  ARCHIVED
}
...
# Dto (inputs)
# 
input CreateCategoryDto @goModel(model: "github.com/smithg09/core/internal/module/category.CreateDto") {
  name: String!
  slug: String
  status: CategoryStatusEnum
}

input WhereCategoriesDto @goModel(model: "github.com/smithg09/core/internal/module/category.WhereDto") {
  name: StringFilter
  slug: StringFilter
  status: CategoryStatusEnum
  sort: SortFilter
...
input UpdateCategoryDto @goModel(model: "github.com/smithg09/core/internal/module/category.UpdateDto") {
  name: String
  slug: String
  status: CategoryStatusEnum
}
...
# 
type Post @goModel(model: "github.com/smithg09/core/internal/module/post.Post") {
  id: Uuid!
  title: String!
  slug: String!
  category: Category!
...
enum PostStatusEnum @goModel(model: "github.com/smithg09/core/internal/module/post.PostStatus") {
  ACTIVE
  PENDING
  ARCHIVED
}
...
# Dto (inputs)
# 
input CreatePostDto @goModel(model: "github.com/smithg09/core/internal/module/post.CreateDto") {
  title: String!
  slug: String
  status: PostStatusEnum!
  category: Uuid!
...
input WherePostsDto @goModel(model: "github.com/smithg09/core/internal/module/post.WhereDto") {
  title: StringFilter
  slug: StringFilter
  category: UuidFilter
  status: PostStatusEnum
...
input UpdatePostDto @goModel(model: "github.com/smithg09/core/internal/module/post.UpdateDto") {
  title: String
  slug: String
  category: Uuid
  status: PostStatusEnum
